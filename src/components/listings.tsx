    ...
    return (
        <section className="bg-transparent py-32 px-6">
            <div className="max-w-7xl mx-auto flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full">
                    {mockListings.map((listing, idx) => (
                        <motion.div
                            ...
                            className="group cursor-pointer bg-white dark:bg-zinc-900 overflow-hidden rounded-[2.5rem] border border-zinc-100 dark:border-white/5 shadow-lg shadow-zinc-200/20 dark:shadow-none hover:shadow-2xl transition-all duration-500"
                        >
                ...
                <button className="md:hidden mt-12 w-full py-4 bg-zinc-100 dark:bg-white/5 text-zinc-900 dark:text-white rounded-2xl font-bold flex items-center justify-center gap-2 transition-colors">
                    Browse all
